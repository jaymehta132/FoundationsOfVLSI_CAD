...
def preprocess() -> None:
    ...
    """
    with open("SequentialATPG/Data/netlist.v", "r") as file:
        lines = file.read()
    # Remove the comments
    ...
    with open("SequentialATPG/Data/processed.txt", "w") as file:
        file.write(lines)
...
def patternRecognition() -> list[list[tuple]]:
    ...
    """
    with open("SequentialATPG/Data/processed.txt", "r") as file:
        data = file.read()
